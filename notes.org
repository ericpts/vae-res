...
#+BEGIN_SRC elisp :results silent
  (defun run-experiment-with-params (beta gamma)
  (setq beta beta)
  (setq gamma gamma)
  (save-excursion
    (goto-char
      (org-babel-find-named-block "sample-experiment"))
...
#+END_SRC
  ...
  #+BEGIN_SRC python :var table=good-hyperparam-table :results value
    for row in table:
        row.append(f"[[elisp:(run-experiment-with-params {row[0]} {row[1]})]]")
    return table
  #+END_SRC
 ...
 |  0.7 |  0.02 |
  ...
  #+CALL: generate-table-with-links(table=good-hyperparam-table)

  #+RESULTS:
  | 0.5 | 0.007 | [[elisp:(run-experiment-with-params 0.5 0.007)]] |
  | 0.5 |  0.01 | [[elisp:(run-experiment-with-params 0.5 0.01)]]  |
  | 0.5 |  0.02 | [[elisp:(run-experiment-with-params 0.5 0.02)]]  |
  | 0.7 | 0.007 | [[elisp:(run-experiment-with-params 0.7 0.007)]] |
  | 0.7 |  0.01 | [[elisp:(run-experiment-with-params 0.7 0.01)]]  |
  | 0.7 |  0.02 | [[elisp:(run-experiment-with-params 0.7 0.02)]]  |



 #+NAME: sample-experiment
 #+BEGIN_SRC sh :var beta=(identity beta) gamma=(identity gamma) digits=(identity digits)
   export run=1
   echo "Running beta=${beta}, gamma=${gamma}"
   python3 sample.py --name leonhard --digits "${digits}" --root-dir ../_save/beta=${beta}_gamma=${gamma}_nvaes=5-coordconv/run-${run} --num-examples 4 --epoch 700
 #+END_SRC

 #+RESULTS: sample-experiment
 | Running | beta=0.5, | gamma=0.007 |            |           |           |            |   |
 | (4,     | 28,       |         56, | 1)         |           |           |            |   |
 | KL      | for       |          0: | [27.470936 |  26.64038 | 25.737038 | 27.853338] |   |
 | KL      | for       |          1: | [18.806267 | 14.671562 | 13.805559 | 21.734085] |   |
 | KL      | for       |          2: | [15.488848 | 19.590532 | 18.339827 | 19.94676   | ] |
 | KL      | for       |          3: | [4.889363  |  5.191582 |   4.70188 | 4.6944566] |   |
 | KL      | for       |          4: | [14.22592  |   13.3612 |  17.30783 | 14.117587] |   |
