...
def main():
    ...
    parser.add_argument('--name', type=str, required=True, help='Name of the model to sample from.')
    parser.add_argument('--sample-from-vaes',
            type=int,
            nargs='+',
    ...
    save_pictures(pictures,
            file_name='sample_from_{}.png'.format(model.name))
